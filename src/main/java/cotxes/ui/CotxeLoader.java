...
public class CotxeLoader extends JFrame {
	...
	protected final CotxeTableModel model;

	/**
	 * Create the frame.
	 */
	public CotxeLoader(CotxeTableModel model) {
		this.model = model;
		addWindowListener(new WindowAdapter() {
			@Override
			public void windowClosing(WindowEvent arg0) {

				int response = JOptionPane.showConfirmDialog(CotxeLoader.this,
						"Si tanques pedras els canvis, estas segur?");
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(lblMatricula).addComponent(lblMarca).addComponent(lblModel)
										.addComponent(lblNombreDePortes).addComponent(lblColor,
												GroupLayout.PREFERRED_SIZE, 113, GroupLayout.PREFERRED_SIZE))
								.addGap(29)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(textColor, GroupLayout.PREFERRED_SIZE, 149,
												GroupLayout.PREFERRED_SIZE)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
												.addComponent(textNumPortes).addComponent(textModel)
												.addComponent(textMarca).addComponent(textMatricula,
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane
						.createParallelGroup(Alignment.BASELINE).addComponent(lblMatricula).addComponent(textMatricula,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblMarca).addComponent(
						textMarca, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblModel).addComponent(
						textModel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				...
				.addGap(13)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblNombreDePortes)
						.addComponent(textNumPortes, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(49).addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnCancelar)
						.addComponent(btnGuardar))
				.addContainerGap(13, Short.MAX_VALUE)));
		contentPane.setLayout(gl_contentPane);
	}

	public void replaceElement(Cotxe c) {
		
		this.textMatricula.setText(c.getMatricula());
		this.textMatricula.setEnabled(false);
		this.textMarca.setText(c.getMarca());
		this.textModel.setText(c.getModel());
		this.textColor.setText(c.getColor());
		this.textNumPortes.setText(c.getNum_portes().toString());
